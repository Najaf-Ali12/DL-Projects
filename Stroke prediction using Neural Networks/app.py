...
# Add an image (replace with your own image path)
...
if age>120:
    st.warning("As a model, I don't think a person have age more than 120")
...
if st.button("Predict Stroke"):
    ...
    #Prediction (uncomment when model is loaded)
...
st.sidebar.info("Developer: Najaf Ali")
st.sidebar.write("Please give your valuable feedback")
feeback=st.sidebar.feedback("stars")
